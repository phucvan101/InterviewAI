    ...
    <div class="flex min-h-screen font-['Be_Vietnam_Pro',sans-serif] overflow-hidden" style="background:#080c22;">
        ...
        <div class="relative flex w-full md:w-1/2 items-center justify-center px-6 py-12" style="background: #0a0d24;">
            ...
            <div class="relative z-10 w-full max-w-[400px] animate-[formIn_0.6s_cubic-bezier(0.22,1,0.36,1)_both]">
                ...
                <div v-if="!isLoggedIn">
                    <div class="mb-8">
                        <h2 class="text-[2rem] font-black text-white tracking-tight mb-1.5">Đăng nhập</h2>
                        <p class="text-sm" style="color: rgba(255,255,255,0.48);">Chào mừng trở lại! Vui lòng nhập thông
                            tin
                            của bạn.</p>
                    </div>
                    ...
                    <form class="flex flex-col gap-4" @submit.prevent="handleLogin">
                        ...
                        <div class="flex flex-col gap-1.5">
                            <label class="text-[0.8rem] font-semibold"
                                style="color: rgba(255,255,255,0.72);">Email</label>
                            <div class="flex items-center rounded-xl border transition-all duration-200" :style="{
                                ...
                                <svg class="w-4 h-4 ml-3.5 flex-shrink-0" style="color: rgba(255,255,255,0.28);"
                                ...
                                <input v-model="form.email" type="email" placeholder="name@company.com"
                                    ...
                                    style="color: rgba(255,255,255,0.88); font-family: inherit;"
                        ...
                        <div class="flex items-center justify-between -mt-1">
                            <label class="flex items-center gap-2 cursor-pointer select-none text-[0.8rem]"
                                style="color: rgba(255,255,255,0.52);">
                                <input type="checkbox" v-model="form.remember"
                                    class="w-[15px] h-[15px] rounded cursor-pointer accent-[#4F46E5]" />
                                Ghi nhớ đăng nhập
                            </label>
                            <a href="#" class="text-[0.8rem] font-semibold transition-colors duration-150"
                                style="color: #4F46E5;" @mouseenter="$event.target.style.color = '#6862DF'">
                                Quên mật khẩu?
                            </a>
                        </div>
                        ...
                        <button type="submit"
                            ...
                            :class="isLoading ? 'opacity-70 pointer-events-none' : 'hover:-translate-y-0.5'"
                            style="background: linear-gradient(135deg, #4F46E5 0%, #5535c8 100%); box-shadow: 0 6px 24px rgba(109,67,245,0.38);"
                            @mouseenter="!isLoading && ($event.currentTarget.style.boxShadow = '0 10px 32px rgba(109,67,245,0.52)')"
                        ...
                        <div class="flex items-center gap-3 my-0.5">
                            ...
                            <span class="text-[0.72rem] whitespace-nowrap" style="color: rgba(255,255,255,0.28);">Hoặc
                                đăng
                                nhập bằng</span>
                            <div class="flex-1 h-px" style="background: rgba(255,255,255,0.07);" />
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-2.5">
                            <button v-for="provider in oauthProviders" :key="provider.name" type="button"
                        ...
                        <!-- Sign up -->
                        <p class="text-center text-[0.82rem] mt-1" style="color: rgba(255,255,255,0.42);">
                            Chưa có tài khoản?
                        <div @click="isLoggedIn = true" class="font-bold transition-colors duration-150"
                            style="color: #4F46E5;" @mouseenter="$event.target.style.color = '#6862DF'">Đăng ký ngay
                        </div>
                        </p>
                ...
                <div v-else>
                    ...
                    <form class="flex flex-col gap-4" @submit.prevent="handleLogin">
                        ...
                        <p class="text-center text-[0.82rem] mt-1" style="color: rgba(255,255,255,0.42);">
                            Chưa có tài khoản?
                            <RouterLink to="/signup" class="font-bold transition-colors duration-150"
                                style="color: #4F46E5;" @mouseenter="$event.target.style.color = '#6862DF'">Đăng ký ngay
                            </RouterLink>
                        </p>
