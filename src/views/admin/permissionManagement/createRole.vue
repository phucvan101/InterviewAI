...
const handleCreateRole = async () => {
    ...
    try {
        await managePermissionStore.createRole({
            name,
            description,
        ...
        ElMessage.error(error?.message || "Không thể tạo vai trò mới");
    }
}
        ...
        <div class="p-6 w-full">
            <div class="flex justify-between items-end mb-5">
                <div style="color: #DFE4FE">
                    <div class="text-3xl font-bold mb-2">Tạo vai trò mới</div>
