...
const features = [
    ...
    { icon: hieu_suat, title: 'RAG thông minh', desc: 'Hệ thống RAG phân tích sâu hồ sơ, đặt câu hỏi đúng trọng tâm như nhà tuyển dụng thực thụ.', bg_color: 'rgba(20,83,45,0.35)' },
